...
export const wssProvider = new ethers.WebSocketProvider(process.env.RPC_URL_WSS);
...
export const authKeyWallet = new ethers.Wallet(process.env.FLASHBOTS_AUTH_KEY, wssProvider);
